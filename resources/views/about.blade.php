...
@section('content')
    <section class="md:px-24 px-5 bg-[#F8F8F8] py-24">
        ...
        <h1
            class="text-[#141D38] md:w-[760px] z-[1000] md:text-6xl animate__animated  animate__bounceInLeft mt-6 text-4xl font-bold md:leading-[70px] leading-[50px] md:text-left text-center">
            Welcome to <span class="text-secondary">MEL HR
                Services</span></h1>
        <p class="text-[#7B808E] md:w-[991px] animate__animated  animate__bounceInLeft md:text-xl text-lg mb-12 font-[Mada] leading-8 mt-6 md:text-left text-center">
            MEL HR
        ...
        <div class="flex md:flex-row flex-col gap-16">
            <div class="md:w-[50%] bg-primary p-6 pb-8 rounded-3xl flex md:flex-row flex-col gap-6" data-aos="fade-up" data-aos-duration="1000">
                <div
