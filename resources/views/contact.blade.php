...
@section('content')
    <section class="md:px-24 px-5 bg-[#F8F8F8] py-24">
        ...
        <p class="text-[#7B808E] md:w-[991px] md:text-xl text-lg mb-28 font-[Mada] leading-8 mt-6 md:text-left text-center">
        ...
        <div class="flex md:flex-row flex-col gap-16">
            <div class="md:w-[33%] bg-primary px-6 pt-16 pb-14 relative rounded-3xl flex md:flex-row flex-col gap-6">
                <div
